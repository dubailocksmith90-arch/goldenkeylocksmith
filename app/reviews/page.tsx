...
export const metadata: Metadata = {
  ...
  description: `Read ${REVIEW_COUNT}+ verified customer reviews for ${BUSINESS_NAME}. ${RATING}★ average rating. Real reviews from Dallas homeowners and businesses. Call (917) 203-4678.`,
