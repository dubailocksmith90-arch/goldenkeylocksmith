...
export const metadata: Metadata = {
  ...
  description:
    'Smart lock installation in Dallas TX. Schlage Encode, August Smart Lock, Yale, Kwikset Halo. Keypad, fingerprint, app control. $150–$350 installed. Call (917) 203-4678.',
}
