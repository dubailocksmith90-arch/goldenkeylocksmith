...
export const metadata: Metadata = {
  ...
  description: `Contact ${BUSINESS_NAME} for locksmith service in Dallas TX. Call (917) 203-4678 for 24/7 emergencies. Licensed, bonded & insured. Free estimates.`,
  alternates: { canonical: `${SITE_URL}/contact/` },
  openGraph: { title: `Contact ${BUSINESS_NAME}`, description: 'Call (917) 203-4678 for 24/7 locksmith service in Dallas TX. Free estimates.', url: `${SITE_URL}/contact/` },
}
