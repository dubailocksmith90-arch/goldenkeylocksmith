...
const faqGroups = [
  {
    ...
    faqs: [
      ...
      { q: 'Can I get a quote over the phone?', a: 'Yes. Call (917) 203-4678 and our team will provide an accurate estimate based on your location, lock type, and the service needed. The final price will be confirmed on-site before any work begins.' },
    ],
  },
  {
    ...
    faqs: [
      ...
      { q: 'Are you available 24 hours a day?', a: 'Yes. We answer calls 24/7, every day of the year including holidays. Emergency lockout service is always available — just call (917) 203-4678.' },
