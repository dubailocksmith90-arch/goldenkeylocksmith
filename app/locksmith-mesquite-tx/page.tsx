...
export const metadata: Metadata = {
  ...
  description:
    'Trusted locksmith in Mesquite TX. Town East, Mesquite Crossing, Sunnyvale area. 24/7 emergency lockout, rekeying, car keys. Licensed & insured. Call (575) 573-2625.',
}
