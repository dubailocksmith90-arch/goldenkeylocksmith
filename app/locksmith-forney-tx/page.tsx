...
export const metadata: Metadata = {
  ...
  description: 'Trusted locksmith serving Forney TX. Emergency lockouts, rekeying, car keys, smart locks & commercial security. Licensed & insured. Call (917) 203-4678.',
  alternates: { canonical: `${SITE_URL}/locksmith-forney-tx/` },
  openGraph: {
    title: `Locksmith Forney TX | ${BUSINESS_NAME}`,
    description: 'Licensed 24/7 locksmith in Forney TX. Fast response, upfront pricing. Call (917) 203-4678.',
