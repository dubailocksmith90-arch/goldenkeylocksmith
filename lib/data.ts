...
export const PHONE = '(917) 203-4678'
export const PHONE_HREF = 'tel:+19172034678'
...
export const homeFaqs = [
  {
    ...
    a: 'Residential lockout $65–$125, car lockout $50–$100, rekeying $15–$35/lock, car key programming $75–$250. Free estimates available — call us at (917) 203-4678 for an exact quote.',
  },
  {
...
export const serviceConfigs: Record<string, ServiceConfig> = {
  'emergency-locksmith': {
    ...
    metaDescription: '24/7 emergency locksmith in Dallas TX. House lockouts, car lockouts, business lockouts. Fast 15–45 min response. Licensed & insured. Call (917) 203-4678 now.',
  ...
  'residential-locksmith': {
    ...
    metaDescription: 'Licensed residential locksmith in Dallas TX. House lockout, rekeying, smart lock installation, deadbolt installation. Fast response, upfront pricing. Call (917) 203-4678.',
  ...
  'commercial-locksmith': {
    ...
    metaDescription: 'Professional commercial locksmith in Dallas TX. Office lockouts, master key systems, access control, high security locks. Licensed & insured. Call (917) 203-4678.',
  ...
  'automotive-locksmith': {
    ...
    metaDescription: 'Expert automotive locksmith in Dallas TX. Car lockouts, transponder key programming, key fob replacement, ignition repair. All makes & models. Call (917) 203-4678.',
  ...
  'rekeying': {
    ...
    metaDescription: 'Professional lock rekeying in Dallas TX. Rekey house after moving, lost keys, or security upgrade. $15–$35 per lock. Same-day service. Call (917) 203-4678.',
  ...
  'key-duplication': {
    ...
    metaDescription: 'Fast key duplication in Dallas TX. House keys, car keys, padlock keys, high security keys. On-site mobile service across Dallas. Call (917) 203-4678.',
